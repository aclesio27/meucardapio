...
const MENU_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vTdx8Pg-hnACGg2X4rD_fANqlwEf7nHcTnmNewBpCQolWSdBjhfpoYZ1uE3T8pJ3jyzhF96XjGGG231/pub?gid=1132427241&single=true&output=csv';

// URL of the spreadsheet with menu categories (tab: Categories)
const CATEGORIES_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vTdx8Pg-hnACGg2X4rD_fANqlwEf7nHcTnmNewBpCQolWSdBjhfpoYZ1uE3T8pJ3jyzhF96XjGGG231/pub?gid=271394769&single=true&output=csv';

// URL of the spreadsheet with general settings (tab: Config)
const CONFIG_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vTdx8Pg-hnACGg2X4rD_fANqlwEf7nHcTnmNewBpCQolWSdBjhfpoYZ1uE3T8pJ3jyzhF96XjGGG231/pub?gid=0&single=true&output=csv';

// URL of the spreadsheet with operating hours (tab: Hours)
const HOURS_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vTdx8Pg-hnACGg2X4rD_fANqlwEf7nHcTnmNewBpCQolWSdBjhfpoYZ1uE3T8pJ3jyzhF96XjGGG231/pub?gid=1842804489&single=true&output=csv';

// URL of the spreadsheet with neighborhoods and delivery fees (tab: Bairros) **OPCIONAL**
const NEIGHBORHOODS_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vTdx8Pg-hnACGg2X4rD_fANqlwEf7nHcTnmNewBpCQolWSdBjhfpoYZ1uE3T8pJ3jyzhF96XjGGG231/pub?gid=1634629476&single=true&output=csv';

// URL da planilha de cupons de desconto  **OPCIONAL**
const COUPONS_CSV_URL = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vTdx8Pg-hnACGg2X4rD_fANqlwEf7nHcTnmNewBpCQolWSdBjhfpoYZ1uE3T8pJ3jyzhF96XjGGG231/pub?gid=1144201431&single=true&output=csv';
 ...
 */
const PRELOADER_LOGO_URL = 'https://drive.google.com/file/d/1ykzfck9SCXVG-3VDWmCMOAcKTQAjm8_5/view?usp=sharing'; // Adicione a URL do seu logo aqui
 ...
 */
const PRELOADER_COLOR = '#1d1813ff'; // Cor principal do preloader
